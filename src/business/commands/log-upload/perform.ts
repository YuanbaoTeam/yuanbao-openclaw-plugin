...
import type { ParsedCommandArgs, CosUploadResult } from "./types.js";
...
function renderReply(cosUpload: CosUploadResult): string {
  if (!cosUpload.recordLogOk) {
    return "导出失败，请稍后重试";
  }
